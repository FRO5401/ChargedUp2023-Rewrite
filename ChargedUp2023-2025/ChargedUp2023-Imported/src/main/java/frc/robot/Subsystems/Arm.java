...
public class Arm extends SubsystemBase {
  ...
  */
  ...
  public Arm() {
    ...
    shoulderLeft.configure(shoulderConfigLeft, null, null);
    shoulderRight.configure(shoulderConfigRight, null, null);
    telescopeMotor.configure(telescopeConfig, null, null);
